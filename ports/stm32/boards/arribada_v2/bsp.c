...
GPIO_InitTypeDefAndPort_t GPIO_Inits[GPIO_TOTAL_NUMBER] =
{
    ...
    {GPIOA, {GPIO_PIN_9,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0}}, // GPIO_4
    {GPIOE, {GPIO_PIN_14, GPIO_MODE_INPUT,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0}}, // GPIO_SWS
    {GPIOB, {GPIO_PIN_2,  GPIO_MODE_INPUT,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0}}, // GPIO_REED_SW
    ...
    {GPIOE, {GPIO_PIN_8,  GPIO_MODE_INPUT,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0}}, // GPIO_GPOUT
    ...
    {GPIOE, {GPIO_PIN_15, GPIO_MODE_INPUT,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0}}, // GPIO_INT1_AG
...
const I2C_InitTypeDefAndInst_t I2C_Inits[I2C_TOTAL_NUMBER] =
{
    ...
    {I2C1, {0x20303E5D, 0, I2C_ADDRESSINGMODE_7BIT, I2C_DUALADDRESS_DISABLE, 0, I2C_OA2_NOMASK, I2C_GENERALCALL_DISABLE, I2C_NOSTRETCH_DISABLE}},
    {I2C2, {0x20303E5D, 0, I2C_ADDRESSINGMODE_7BIT, I2C_DUALADDRESS_DISABLE, 0, I2C_OA2_NOMASK, I2C_GENERALCALL_DISABLE, I2C_NOSTRETCH_DISABLE}},
};
...
const UART_InitTypeDefAndInst_t UART_Inits[UART_TOTAL_NUMBER] =
{
    ...
    {USART2, {3000000, UART_WORDLENGTH_8B, UART_STOPBITS_1, UART_PARITY_NONE, UART_MODE_TX,    UART_HWCONTROL_NONE, UART_ONE_BIT_SAMPLE_DISABLE, UART_ADVFEATURE_NO_INIT}},
