...
const UART_InitTypeDefAndInst_t UART_Inits[UART_TOTAL_NUMBER] =
{
    ...
    {USART2, {9600,    UART_WORDLENGTH_8B, UART_STOPBITS_1, UART_PARITY_NONE, UART_MODE_TX,    UART_HWCONTROL_NONE, UART_OVERSAMPLING_16, UART_ADVFEATURE_NO_INIT}},
    {USART3, {9600,    UART_WORDLENGTH_8B, UART_STOPBITS_1, UART_PARITY_NONE, UART_MODE_TX_RX, UART_HWCONTROL_NONE, UART_OVERSAMPLING_16, UART_ADVFEATURE_NO_INIT}},
};
