...
const GPIO_InitTypeDefAndPort_t GPIO_Inits[GPIO_TOTAL_NUMBER] =
{
    ...
    {GPIOB, {GPIO_PIN_7,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF1_USART1}}, // GPIO_UART1_RX
...
const UART_InitTypeDefAndInst_t UART_Inits[UART_TOTAL_NUMBER] =
{
    ...
    {USART1, {9600,   UART_WORDLENGTH_8B, UART_STOPBITS_1, UART_PARITY_NONE, UART_MODE_TX_RX, UART_HWCONTROL_NONE, 0, 0}},
