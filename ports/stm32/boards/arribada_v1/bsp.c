...
const UART_InitTypeDefAndInst_t UART_Inits[UART_TOTAL_NUMBER] =
{
    ...
    {USART1, {921600, UART_WORDLENGTH_8B, UART_STOPBITS_1, UART_PARITY_NONE, UART_MODE_TX_RX, UART_HWCONTROL_NONE, UART_ONE_BIT_SAMPLE_DISABLE, UART_ADVFEATURE_NO_INIT}},
